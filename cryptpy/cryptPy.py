...
def main_screen():
        ...
        #text area for text to be encrypted
        ...
        #text area for the secret key
        Label(text="Enter secret key for encryption and decryption", fg="black",font=("calbri,13")).place(x=10,y=170)
        
        code=StringVar()
        Entry(textvariable=code,width=19,bd=0,font=("aril",25),show="*").place(x=10,y=200)
        #encrypt button
